# LOGO training on Qwen3-8B with GSM8K
# Based on the GRPO example with LOGO-specific overrides.
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_logo_gsm8k' \
    trainer.experiment_name='qwen3_8b_logo' \
